# Scalable Data Engineering Pipeline + Dashboard
...
![Alternative Text](dashboard_app/dashboard.png)

![Alternative Text](dashboard_app/job-dashboard.png)

![Alternative Text](dashboard_app/dashboard-view.png)
